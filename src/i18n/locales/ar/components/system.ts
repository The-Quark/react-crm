const System = {
  ...
  'SYSTEM.NEW_AIRLINE': 'شركة طيران جديدة',
  'SYSTEM.AIRLINE_RATES': 'أسعار شركات الطيران',
  'SYSTEM.NEW_AIRLINE_RATE': 'سعر جديد لشركة الطيران',
  'SYSTEM.PRICE_PER_KG': 'السعر لكل كيلوغرام',
  'SYSTEM.FROM_CITY': 'من المدينة',
  'SYSTEM.TO_CITY': 'إلى المدينة',
  'SYSTEM.FROM_COUNTRY': 'من البلد',
  'SYSTEM.SELECT_FROM_COUNTRY': 'اختر بلد المغادرة',
  'SYSTEM.SEARCH_FROM_COUNTRY': 'البحث عن بلد المغادرة',
  'SYSTEM.SELECT_FROM_CITY': 'اختر مدينة المغادرة',
  'SYSTEM.TO_COUNTRY': 'اختر بلد الوجهة',
  'SYSTEM.MIN_WEIGHT': 'الوزن الأدنى',
  'SYSTEM.MAX_WEIGHT': 'الوزن الأقصى',
  'SYSTEM.DELIVERY_TYPES': 'أنواع التوصيل',
  'SYSTEM.NEW_DELIVERY_TYPE': 'نوع توصيل جديد',
  'SYSTEM.SEARCH_DELIVERY_TYPE': 'البحث عن نوع التوصيل',
  'SYSTEM.SEARCH_PACKAGE_TYPE': 'البحث عن أنواع الطرود',
  'SYSTEM.NEW_PACKAGE_TYPE': 'أنواع طرود جديدة',
  'SYSTEM.LANGUAGES_CODE': 'رمز اللغات',
  'SYSTEM.PACKAGE_MATERIALS': 'مواد التعبئة',
  'SYSTEM.SEARCH_PACKAGE_MATERIAL': 'البحث عن مادة التعبئة',
  'SYSTEM.NEW_PACKAGE_MATERIAL': 'مادة تعبئة جديدة',
  'SYSTEM.UNIT': 'الوحدة',
  'SYSTEM.SELECT_UNIT': 'اختر الوحدة',
  'SYSTEM.UNITS': 'الوحدات',
  'SYSTEM.NEW_UNIT': 'وحدة جديدة',
  'SYSTEM.SEARCH_UNIT': 'البحث عن وحدة',
  'SYSTEM.TEMPLATES': 'القوالب',
  'SYSTEM.NEW_TEMPLATE': 'قالب جديد',
  'SYSTEM.SEARCH_TEMPLATE_CODE': 'البحث عن رمز القالب',
  'SYSTEM.TITLE': 'العنوان',
  'SYSTEM.SUBJECT': 'الموضوع',
  'SYSTEM.CONTENT': 'المحتوى',
