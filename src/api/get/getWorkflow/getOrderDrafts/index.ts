...
import { ORDER_MY_DRAFTS } from '@/api/url';
...
const getOrderDrafts = async ({
  ...
  return await axios.get<IOrdersResponse>(ORDER_MY_DRAFTS, { params }).then((res) => res.data);
};

export { getOrderDrafts };
