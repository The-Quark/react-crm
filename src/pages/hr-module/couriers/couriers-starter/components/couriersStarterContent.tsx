...
export const CouriersStarterContent: FC<Props> = ({ isEditMode, usersData, userId }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting, resetForm }) => {
      ...
      try {
        ...
        navigate('/hr-module/couriers/list');
        resetForm();
        setSearchTerms({
          company: '',
          department: '',
  ...
  useEffect(() => {
    if (formik.values.courier_type === UserCourierType.PEDESTRIAN) {
  ...
  const isLoading = companiesLoading || vehiclesLoading || countriesLoading;
          ...
          <div className="card-body grid gap-5">
            ...
            {formik.values.courier_type !== UserCourierType.PEDESTRIAN && (
              <SharedAutocomplete
                ...
                searchTerm={searchTerms.vehicle}
                onSearchTermChange={(term) => setSearchTerms({ ...searchTerms, vehicle: term })}
              />
            )}
            <SharedSelect
