...
import { ApplicationsBlock } from '@/pages/trash/blocks/applications/applicationsBlock.tsx';
import { Application } from '@/api/get/getWorkflow/getApplications/types.ts';
import { SharedError, SharedLoading } from '@/partials/sharedUI';
import { OrdersBlock } from '@/pages/trash/blocks/orders/ordersBlock.tsx';
import { Order } from '@/api/get/getWorkflow/getOrder/types.ts';
import { PackagesBlock } from '@/pages/trash/blocks/packages/packagesBlock.tsx';
import { Package } from '@/api/get/getWorkflow/getPackages/types.ts';
import { Cargo } from '@/api/get/getWorkflow/getCargo/types.ts';
import { CargoBlock } from '@/pages/trash/blocks/cargo/cargoBlock.tsx';
